 ...
 *
 * 重写源码，添加方法
 * 1.getAllRadioButton(): 获取MultiRadioGroup中子view的RadioButton
 * 2.setCheckWithoutNotif(int id): 设置id为checked，一个checked的view设置为false
 */
public class MultiRadioGroup extends LinearLayout {
     ...
     *
     * <p>See
     * {@link {android.R.styleable.inearLayout_Layout} LinearLayout Attributes}
